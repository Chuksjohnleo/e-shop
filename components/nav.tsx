     ...
     <nav className='flex justify-between py-2 p-1 items-center'>
      ...
      <div className='flex gap-1 xSm:gap-4 sm:gap-6 text-center p-1 px-3 rounded-lg'>
         ...
         <Link className='relative' href='/'>
          ...
          <span className='absolute pointer-events-none -top-2.5 -right-0.5 inline-block text-[13px] text-[white] bg-primaryColor px-1 rounded-full'>9</span>
         </Link>
         ...
         <Link className='relative' href='/'>
          ...
          <span className='absolute pointer-events-none -top-2.5 -right-1.5 inline-block text-[13px] text-[white] bg-primaryColor px-1 rounded-full'>4</span>
         </Link>
      </div>
     </nav>
